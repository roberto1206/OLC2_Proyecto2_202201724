        ...
        props: [
            {
                name: 'cond',
                type: 'Expresion',
                description: 'Condicion del switch'
            },
            {
                name: 'cases',
                type: 'Expresion[] | undefined',
        ...
        props: [
            {
                name: 'id',
                type: 'Expresion',
                description: 'Expresion que es el id'
            },
            {
                name: 'tipos',
                type: 'String | undefined',
                description: 'El tipo de func'
            },
            {
                name: 'expr1',
                type: 'Expresion | undefined',
                description: 'Expresion que puede venir'
            }
        ]
    },
    //for each
    ...
    //matriz
    {
        ...
        props: [
            ...
            },
            {
                name: 'dimension',
                type: 'String[]',
                description: 'dimension de la matriz'
            },
            {
                name: 'id',
                type: 'String',
